...
const HeroSection = () => {
    ...
    let userActivitySummary = [
        { label: 'Available Jobs', count: userDetails?.number_of_jobs_posted || '00', svgIcon: 'signPost', url: '/my-jobs' },
        { label: 'My Proposals', count: userActivityCount?.proposal_count || '00', svgIcon: 'proposalsDocument', url: { pathname: '/my-proposals', state: { activeTab: 'Proposals' } } },
                    ...
                    >
                        ...
                        >
                            <div className="heading">
                                ...
                                >You are one step away from finding amazing jobs</span>
                            </div>
                            <div className="content">
                                <span
                                    className="font-figtree text-[#17181C] text-sm md:text-base"
                                >
                                    Discover Your Next Career Opportunity and Unlock New Possibilities!
                                </span>
                            </div>
                            <div className="flex">
                                <NavigatePage url="/find-work">
                                    <GradientButton>
                                        Find Job
                                    </GradientButton>
                                </NavigatePage>
